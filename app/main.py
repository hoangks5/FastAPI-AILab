...
async def PersistAD_upload_file(in_file: UploadFile=File(...), c: float = Form(3.0), side: str = Form('both',description="""If “both”, to detect anomalous positive and negative changes;
